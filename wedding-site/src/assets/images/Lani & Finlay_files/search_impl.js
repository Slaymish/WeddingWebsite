google.maps.__gjsload__('search_impl', function (_) {
  var Jgb = function (a, b) {
    ...
    Ngb = function (a, b, c) {
      ...
      e.push(
        _.dk(a, 'clickable_changed', function () {
    ...
    Lgb = function (a, b, c, d, e) {
      ...
      if (e && ((f = { status: e.getStatus() }), 0 == e.getStatus())) {
        f.location = _.Y(e.j, 2)
          ? new _.tj(_.Au(_.M(e.j, 2, _.Gu).j, 1), _.Au(_.M(e.j, 2, _.Gu).j, 2))
          : null
        f.fields = {}
        const h = _.ei(e.j, 3)
        for (let k = 0; k < h; ++k) {
  ...
  Ogb.prototype.FA = function (a) {
    if (_.Zm[15]) {
      ...
      b &&
        a.g &&
        (a.i
          ? ((b = b.__gm.h), b.set(b.get().gh(a.g)))
          : a.g && _.rKa(a.g, b) && (_.Lb(a.h || [], _.fk), (a.h = null)))
      if (c) {
        b = new _.Ey()
        ...
        a.get('spotlightDescription') &&
          (b.spotlightDescription = new _.cz(a.get('spotlightDescription')))
        ...
        a.get('searchPipeMetadata') &&
          (b.searchPipeMetadata = new _.tB(a.get('searchPipeMetadata')))
        ...
        a.get('airQualityPipeMetadata') &&
          (b.airQualityPipeMetadata = new _.Fga(a.get('airQualityPipeMetadata')))
        a.get('directionsPipeParameters') &&
          (b.directionsPipeParameters = new _.Dga(a.get('directionsPipeParameters')))
