  ...
  <div class="form-container">
    <transition name="fade" mode="out-in">
      <div :key="step">
        ...
        <!-- Step 5 -->
        <div
          v-if="(step === 5 && hasDietaryRequirements) || (step === 5 && !hasDietaryRequirements)"
        >
        ...
        <div v-if="step === 6">
          ...
          <div class="rsvp-confirmation">
            ...
            <p v-if="hasDietaryRequirements">
              <strong>Dietary Requirements:</strong> {{ dietaryRequirements }}
            </p>
